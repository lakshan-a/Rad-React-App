...
export default class Product extends Component<ProductProps,productStart> {
  ...
  render() {
    ...
    // @ts-ignore
    const image = require('../../../images/laptop.png' + data.image)
    ...
    return (
      ...
      >
          <img className=' w-[300px] m-auto mt-5' src={image} alt="" />
        <a href="#">
          <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white m-5">
